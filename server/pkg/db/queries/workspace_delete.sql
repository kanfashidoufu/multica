...
deleted_notification_deliveries AS (
    DELETE FROM notification_delivery WHERE workspace_id = $1
),
deleted_lark_invitation_deliveries AS (
    DELETE FROM lark_invitation_delivery WHERE workspace_id = $1
),
deleted_inbox AS (
