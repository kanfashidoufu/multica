...
-- (lark_chat), which fixed the identical gap for Lark. Keep the external_issue
-- value added by 117; this migration widens the current constraint and must not
-- regress previously allowed origins.
