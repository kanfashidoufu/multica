...
-- defeating the split.
--
-- The downstream distribution added external_issue in migration 117. Keep it
-- in the rebuilt list so Syndra imports remain valid during this upgrade.
ALTER TABLE issue DROP CONSTRAINT IF EXISTS issue_origin_type_check;
ALTER TABLE issue ADD CONSTRAINT issue_origin_type_check
    CHECK (origin_type IN ('autopilot', 'quick_create', 'lark_chat', 'external_issue', 'slack_chat', 'agent_create', 'dingtalk_chat'))
    NOT VALID;
